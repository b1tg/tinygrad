...
def least_upper_float(dt:DType) -> DType:
  # when promoting ints to float domain, always use the current default float
  # this ensures operations like int/int division return exactly dtypes.default_float
  return dt if dtypes.is_float(dt) else dtypes.default_float
