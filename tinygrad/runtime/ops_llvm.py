...
class LLVMCompiler(Compiler):
  def __init__(self, target_arch:str, triple:str, cpu:str, feats:str, jit:bool=False, cache_key:str="llvm"):
    ...
    self.target_machine = llvm.LLVMCreateTargetMachine(target, triple.encode(), cpu.encode(), feats.encode(),
...
class HostLLVMCompiler(LLVMCompiler):
  def __init__(self):
    ...
    triple = {'AArch64': 'aarch64', 'X86': 'x86_64'}[host_arch] + '-none-unknown-elf'
    ...
    super().__init__(host_arch, triple, cpu.decode(), feats.decode(), jit=True, cache_key="llvm_jit")
