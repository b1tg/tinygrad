...
from tinygrad.runtime.support.compiler_amd import AMDHIPCompiler
...
class HIPDevice(Compiled):
  def __init__(self, device:str=""):
    ...
    super().__init__(device, HIPAllocator(self), HIPRenderer(self.arch), AMDHIPCompiler(self.arch), functools.partial(HIPProgram, self))
