...
amd_cdna_161632 = [TensorCore(dims=(16,16,32), threads=64, elements_per_thread=(8,8,4), dtype_in=di, dtype_out=do,
  ...
  for di,do in [(dtypes.fp8e5m2,dtypes.float),(dtypes.fp8e4m3,dtypes.float),(dtypes.fp8e5m2fnuz,dtypes.float),(dtypes.fp8e4m3fnuz,dtypes.float),
                (dtypes.half,dtypes.float),(dtypes.bfloat16,dtypes.float)]]

amd_cdna3 = amd_cdna_161632[:4] + amd_cdna_161616
