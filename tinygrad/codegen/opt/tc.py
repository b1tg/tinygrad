...
amd_cdna_323264 = [TensorCore(dims=(32,32,64), threads=64, elements_per_thread=(32,32,16), dtype_in=di, dtype_out=do,
  opts=("l0","l0","l0","l0","l0","u1","u1","u1","u1","l1"),
  swizzle=((('u0', 'u1', 'l5', 'u2', 'u3', 'r5'), ('r0', 'r1', 'r2', 'r3'), ('l0', 'l1', 'l2', 'l3', 'l4', 'r4')),
           (('l0', 'l1', 'l2', 'l3', 'l4', 'r5'), ('r0', 'r1', 'r2', 'r3'), ('l5', 'u0', 'u1', 'u2', 'u3', 'r4'))))
...
amd_cdna4 = amd_cdna_323264 + amd_cdna_1616128 + amd_cdna_161632 + amd_cdna_161616
