...
cuda_81632_f8 = [TensorCore(dims=(8,16,32), threads=32, elements_per_thread=(16,8,4), dtype_in=(di, di), dtype_out=do, opts=cuda_tc_opts,
...
amd_cdna_1616128 = [TensorCore(dims=(16,16,128), threads=64, elements_per_thread=(32,32,4), dtype_in=(di, di), dtype_out=do,
  opts=("l0","l0","l0","l0","u1","u1","l1","l1"),
