...
class TestDtypeTolist(unittest.TestCase):
  ...
  def test_fp8(self):
    self.assertEqual(Tensor([1.5, 3.1], device="PYTHON", dtype=dtypes.fp8e4m3).tolist(), [1.5, 3.0])
    self.assertEqual(Tensor([1.5, 3.1], device="PYTHON", dtype=dtypes.fp8e5m2).tolist(), [1.5, 3.0])
