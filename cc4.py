...
from  examples.mlperf.initializers import FP8LinearBert, LinearBert, FP8LinearBertRow, FP8LinearBertBasic
...
if __name__ == "__main__":
    ...
    ds_layer = FP8LinearBertBasic(IN_DIM, OUT_DIM, bias=True)
