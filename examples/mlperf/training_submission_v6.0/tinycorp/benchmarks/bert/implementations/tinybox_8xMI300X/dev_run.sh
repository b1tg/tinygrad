...
export WANDB=1
# TC128=1 GPUS=1 BS=128 EVAL_BS=128 CUSTOM_CLAMP=1 CUSTOM_AMAX=1 FP8=0 WANDB_NAME="1/128 FP8=1 TC128=1 output" RUNMLPERF=1 python3 examples/mlperf/model_train.py
TC128=1 GPUS=8 BS=1024 EVAL_BS=1024 CUSTOM_CLAMP=1 CUSTOM_AMAX=1 FP8=1 WANDB_NAME="qkvCON+output+im 8/1024 FP8=1 TC128=1" RUNMLPERF=1 python3 examples/mlperf/model_train.py
