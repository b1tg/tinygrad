...
# NOTE: changed back function
TC128=1 GPUS=8 BS=1024 EVAL_BS=1024 CUSTOM_CLAMP=1 CUSTOM_AMAX=0 FP8=1 WANDB_NAME="1=FP8 beam timeout 15" RUNMLPERF=1 python3 examples/mlperf/model_train.py
...
# TC128=1 GPUS=8 BS=1024 EVAL_BS=1024 CUSTOM_CLAMP=1 CUSTOM_AMAX=0 FP8=2 FP8_CACHED=1 WANDB_NAME="FP8=1" RUNMLPERF=1 python3 examples/mlperf/model_train.py
# TC128=0 GPUS=8 BS=1024 EVAL_BS=1024 CUSTOM_CLAMP=1 CUSTOM_AMAX=0 FP8=2 WANDB_NAME="FP8=2" RUNMLPERF=1 python3 examples/mlperf/model_train.py
