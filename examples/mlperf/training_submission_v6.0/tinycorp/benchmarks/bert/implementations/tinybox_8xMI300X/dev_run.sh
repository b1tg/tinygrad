...
TC128=1 GPUS=8 BS=1024 EVAL_BS=1024 CUSTOM_CLAMP=1 CUSTOM_AMAX=1 FP8=1 WANDB_NAME="8/1024 FP8=1 TC128=1 output" RUNMLPERF=1 python3 examples/mlperf/model_train.py
