...
TC128=1 GPUS=8 BS=1024 EVAL_BS=1024 CUSTOM_CLAMP=1 CUSTOM_AMAX=0 FP8=1 WANDB_NAME="-back -max1-nround allCON+output+im" RUNMLPERF=1 python3 examples/mlperf/model_train.py
