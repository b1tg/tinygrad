...
# export DEFAULT_FLOAT="HALF" GPUS=2 BS=128 EVAL_BS=128
# export DEFAULT_FLOAT="HALF" GPUS=4 BS=128 EVAL_BS=128 # fault  MMU fault: 0xFFFFFFBFE000
...
# WANDB_NAME="GPU=8 FP8=1" FP8=1 RUNMLPERF=1 python3 examples/mlperf/model_train.py
export HCQDEV_WAIT_TIMEOUT_MS=300000
WANDB_NAME="GPU=8 BS=1024 FP8=0" FP8=0 RUNMLPERF=1 python3 examples/mlperf/model_train.py