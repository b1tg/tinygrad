...
export WANDB=1
TC128=1 GPUS=1 BS=128 EVAL_BS=128 CUSTOM_CLAMP=1 CUSTOM_AMAX=1 FP8=1 WANDB_NAME="1/1-custom TC128=1 output 1/128 " RUNMLPERF=1 python3 examples/mlperf/model_train.py
