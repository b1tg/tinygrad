...
def buffer_parse(onnx_tensor: TensorProto) -> Tensor:
  # print(f"old buffer_parse ({onnx_tensor.name}) , {onnx_tensor.float_data=}, {onnx_tensor.int32_data=}, \
  #       {onnx_tensor.int64_data=}, {onnx_tensor.double_data=}, {onnx_tensor.uint64_data=}, {onnx_tensor.dims=}")
...
class OnnxRunner:
  def __init__(self, model: ModelProto|SimpleNamespace):
    ...
    # print(f"=== old runner ===, {self.graph_values=},{self.graph_inputs=},{self.graph_outputs=},{self.graph_nodes=}, ")
